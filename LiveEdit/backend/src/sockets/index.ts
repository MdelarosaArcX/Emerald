...
export const SOCKET_EVENTS = {
  ...
  // timeline. Deliberately distinct from RECORDING_CHANGED (capture on/off state) even though
  // both are capture-related — different payload shape, different consumer.
